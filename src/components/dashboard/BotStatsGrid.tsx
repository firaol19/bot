    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-xs text-gray-600 dark:text-gray-400">Buys</span>
                    </div>
                ...
                <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-xs text-gray-600 dark:text-gray-400">Sells</span>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {/* Average Profit */}
                <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-4">
                    <span className="text-xs text-gray-600 dark:text-gray-400 block mb-2">Avg Profit/Trade</span>
                ...
                <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-xs text-gray-600 dark:text-gray-400">Best Trade</span>
                    </div>
                ...
                {/* Worst Trade */}
                <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-4">
                    <span className="text-xs text-gray-600 dark:text-gray-400 block mb-2">Worst Trade</span>
            ...
            {/* Runtime Info */}
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-900 dark:to-gray-800 border border-blue-100 dark:border-gray-700 rounded-lg p-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <div className="flex items-center gap-2 mb-2">
                            <Clock className="w-4 h-4 text-blue-400" />
                            <span className="text-sm text-gray-600 dark:text-gray-400">Running Time</span>
                        </div>
                        <p className="text-lg font-bold text-blue-400">{stats.runningTimeFormatted}</p>
                    </div>
                    <div>
                        <span className="text-sm text-gray-600 dark:text-gray-400 block mb-2">Last Activity</span>
                        <p className="text-lg font-medium text-gray-900 dark:text-gray-300">{getLastActivityText()}</p>
                    </div>
                </div>
            </div>
        </div>
