...
export function AnalyticsCard({ trades }: { trades: Trade[] }) {
    ...
    return (
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-6">
            <h3 className="font-semibold mb-4 text-gray-600 dark:text-gray-300">Strategy Analytics</h3>
            <div className="grid grid-cols-2 gap-4">
                <div className="p-3 bg-white dark:bg-gray-950 rounded-lg">
                    <span className="text-xs text-gray-500 dark:text-gray-500 block">Win Rate</span>
                ...
                <div className="p-3 bg-gray-50 dark:bg-gray-950 rounded-lg">
                    <span className="text-xs text-gray-500 dark:text-gray-500 block">Profit Factor</span>
                    <span className={`font-bold text-lg ${profitFactor >= 1.5 ? 'text-green-600 dark:text-green-400' : 'text-gray-900 dark:text-gray-300'}`}>
                        {profitFactor.toFixed(2)}
                    </span>
                </div>
                <div className="p-3 bg-gray-50 dark:bg-gray-950 rounded-lg">
                    <span className="text-xs text-gray-500 dark:text-gray-500 block">Total Volume</span>
                    <span className="font-medium text-gray-900 dark:text-gray-300">
                        ${totalVolume.toLocaleString()}
                    </span>
                </div>
                <div className="p-3 bg-white dark:bg-gray-950 rounded-lg">
                    <span className="text-xs text-gray-500 dark:text-gray-500 block">Avg. Profit</span>
