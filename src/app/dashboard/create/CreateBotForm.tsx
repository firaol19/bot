...
export default function CreateBotForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (tradeValue < 1.1) {
            alert(`Trade size for each order ($${tradeValue.toFixed(2)}) is too small. Bybit requires at least $1.00 USDT per trade.`);
            return;
        }
        ...
        <div className="max-w-2xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-blue-900/30 to-purple-900/30 border border-blue-800/50 rounded-xl p-6 mb-6">
                <div className="flex items-center justify-between mb-4">
                    ...
                    <button onClick={fetchBalance} disabled={loadingBalance} className="p-2 hover:bg-blue-900/30 rounded-lg transition disabled:opacity-50">
