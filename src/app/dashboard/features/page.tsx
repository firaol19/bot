        ...
        <div className="space-y-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    <Link href="/dashboard" className="p-2 hover:bg-gray-100 dark:bg-gray-800 rounded-full transition text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:text-white">
                        <ArrowLeft size={24} />
                    </Link>
                    <h1 className="text-2xl md:text-3xl font-bold flex items-baseline gap-2">
                        Features Management
                        <span className="text-gray-500 dark:text-gray-500 text-base md:text-lg font-normal">/ {currentMode === 'REAL' ? 'Real' : 'Demo'}</span>
                    </h1>
                </div>
                <Link
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="bg-gray-50 dark:bg-gray-900 p-6 rounded-xl border border-gray-200 dark:border-gray-800">
                    <h3 className="text-gray-600 dark:text-gray-400 text-sm">Active Features Bots</h3>
                    <p className="text-3xl font-bold mt-2 text-yellow-500">{bots.filter(b => b.status === 'RUNNING').length}</p>
                </div>
                <div className="bg-gray-50 dark:bg-gray-900 p-6 rounded-xl border border-gray-200 dark:border-gray-800">
                    <h3 className="text-gray-600 dark:text-gray-400 text-sm">Features Profit</h3>
                ...
                <div className="bg-gray-50 dark:bg-gray-900 p-6 rounded-xl border border-gray-200 dark:border-gray-800">
                    <h3 className="text-gray-600 dark:text-gray-400 text-sm">Active Trades</h3>
            ...
            <div className="bg-gray-50 dark:bg-gray-900/50 rounded-2xl border border-gray-200 dark:border-gray-800 p-6">
                ...
                {bots.length === 0 ? (
                    <div className="text-center py-12 border-2 border-dashed border-gray-200 dark:border-gray-800 rounded-xl">
                        ...
                        <p className="text-gray-500 dark:text-gray-500">No Features bots found for this mode.</p>
                        <Link
                            href={`/dashboard/features?view=${currentMode === 'REAL' ? 'real' : 'demo'}`}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {bots.map((bot: any) => (
                            <div key={bot.id} className="bg-[#0c0c0c] rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden relative group hover:border-yellow-500/30 transition-colors">
                                <div className="p-6">
                                    <div className="flex justify-between items-start mb-4">
                                        <div>
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="text-gray-600 dark:text-gray-400 text-sm font-medium">{bot.symbol}</span>
                                            </div>
                                        </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4 py-4 border-y border-gray-200 dark:border-gray-800/50 mb-6">
                                        <div>
                                            <p className="text-gray-500 dark:text-gray-500 text-[10px] uppercase font-bold tracking-widest">Capital</p>
                                            <p className="text-gray-900 dark:text-white font-medium">${bot.capital.toFixed(2)}</p>
                                        </div>
                                        <div className="text-right">
                                            <p className="text-gray-500 dark:text-gray-500 text-[10px] uppercase font-bold tracking-widest">Realized PnL</p>
                                    ...
                                    <div className="flex items-center gap-3">
                                        <Link
                                            ...
                                            className="flex-1 py-2.5 bg-gray-100 dark:bg-gray-800 hover:bg-gray-700 text-gray-900 dark:text-white text-center rounded-lg transition text-xs font-bold"
                                        >
                                            Analysis
                                        </Link>
                                        <Link
                                            href={`/dashboard/features/bot/${bot.id}/settings`}
                                            className="px-4 py-2.5 bg-gray-100 dark:bg-gray-800/50 hover:bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:text-white rounded-lg transition"
                                        >
